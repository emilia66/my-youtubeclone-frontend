...
export default defineComponent({
  ...
  setup (props, context) {
    ...
    // 使用凭证的方式创建上传视频
    // 阿里云相关文档参考：https://help.aliyun.com/document_detail/52204.html?spm=a2c4g.11186623.6.1019.51d81fe4BQEtZk
    // 阿里云静态文件放在public目录下
    const createUploader = () => {
      const uploader = new window.AliyunUpload.Vod({
        // userID，必填，您可以使用阿里云账号访问账号中心（https://account.console.aliyun.com/），即可查看账号ID
        userId: '1459956579723120',
        ...
        onUploadstarted: async function (uploadInfo: any) {
          ...
          if (uploadInfo.videoId) {
            ...
            console.log('onUploadstarted222')
