        ...
        <div class="channel-info-description">
          <div class="channel-info-flex">
            <div class="channel-info flex-row">
              <img
                class="avatar md"
                src="https://pic.onlinewebfonts.com/svg/img_545526.png"
                alt="channel avatar"
              />
      ...
      <div class="related-videos">
        ...
        <a href="/watch/3ac30e23-45a6-4eca-9430-3654142a772c"
          ><div class="sc-fzozJi dteCCc">
            <img
              class="thumb"
              src="https://p9.itc.cn/q_70/images03/20210930/4e32012134fd40009713f3febc3c6fd1.png"
              alt="thumbnail"
            />
        ...
        ><a href="/watch/05f411f6-9c9d-4e97-8d65-47847cd99e87"
          ><div class="sc-fzozJi dteCCc">
            <img
              class="thumb"
              src="http://n.sinaimg.cn/spider2021331/266/w640h426/20210331/9a36-knaqvqn7660815.jpg"
              alt="thumbnail"
            />
            <div class="video-info-container">
              <div class="channel-avatar"></div>
